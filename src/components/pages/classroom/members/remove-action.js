      ...
      <Card className="w-full max-w-[500px]" {...props} ref={bodyRef}>
        ...
        <CardBody className="px-4">
          <p className="text-small text-default-500 mt-1 px-2">
            {self
              ? "Are you sure you want to leave this classroom? You will no longer have access to the classroom and its resources."
              : "You are about to remove this user from the classroom. Are you sure you want to proceed?"}
          </p>
          {error && (
