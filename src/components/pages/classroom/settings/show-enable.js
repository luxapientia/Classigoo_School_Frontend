...
export default function EnableInvitation({ handleClose, handleSubmit, loading, ...props }) {
      ...
      <Card className="w-full max-w-[500px]" {...props} ref={bodyRef}>
        ...
        <CardBody className="px-4">
          <p className="text-small text-default-500 mt-1 px-2">
            If you enable the invitation code, new members will be able to join this classroom using the code.
          </p>
          ...
          <div className="flex w-full flex-wrap-reverse items-center justify-between gap-2 px-4 pt-4 md:flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button color="success" type="submit" isLoading={loading} onPress={handleSubmit}>
                Enable
              </Button>
            </div>
          </div>
