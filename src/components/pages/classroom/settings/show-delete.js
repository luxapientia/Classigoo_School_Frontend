...
import { Card, CardHeader, CardBody, Button, Spacer, Divider, Input } from "@heroui/react";

export default function DeleteConfirmation({ handleClose, handleSubmit, loading, ...props }) {
      ...
      <Card className="w-full max-w-[500px]" {...props} ref={bodyRef}>
        ...
        <CardBody className="px-4">
          <p className="text-small text-default-500 mt-1 px-2">
            Type <strong>DELETE</strong> to confirm that you want to delete this classroom. This action is irreversible.
          </p>
          <Spacer y={6} />
          <Input
            type="text"
