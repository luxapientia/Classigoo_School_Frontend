...
export default function QuestionBuilder({ index, question: qobj, updateQuestion, cancleQuestion }) {
  ...
  return (
    <>
            ...
            <div className="bg-white dark:bg-neutral-700 rounded-lg p-5 max-w-[calc(100vw_-_30px)] w-[750px] max-h-[calc(100vh_-_100px)] sm:max-h-[calc(100vh_-_150px)] md:max-h-[calc(100vh_-_50px)] mb-[50px] md:mb-0 overflow-y-auto"><h1 className="text-2xl font-bold text-center font-exo my-4 mb-8">Update Question</h1>
          {error?.length > 0 && (
            <Alert
              color="danger"
