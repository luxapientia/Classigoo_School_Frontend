...
// Dynamic problem generator for multiplication (1, 2, and 3 digits)
const generateMultiplicationProblem = () => {
  // Generate random operands with different digit lengths
  let op1, op2;
  
  // 20% chance for 2-digit numbers, 40% chance for 1-digit numbers 40% chance for mix of 1 and 2 digit numbers
...
export default function MultiplicationActivity({ user }) {
  ...
  if (!currentProblem) {
    return (
      <ActivityLayout title="Multiplication">
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mt-8 text-center pb-6">
            <p className="text-gray-600">
              Solve the multiplication problem and click Next for a new one!
            </p>
          </div>
        </div>
      </div>
