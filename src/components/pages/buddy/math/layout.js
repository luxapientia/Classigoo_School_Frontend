...
export default function MathLayoutComponent({
  user_data,
  children,
  setError,
  isLoading,
              ...
              <div className="flex">
                ...
                <div className="flex-initial flex gap-2">
                  ...
                  <Button
                    ...
                    className="flex items-center gap-2 text-gray-700 dark:text-white bg-content2 rounded-full"
                    isIconOnly
                    onClick={() => router.push("/buddy/math")}
                  >
                ...
                {historyLoading ? (
                  ...
                  history.map((item, index) => (
                    <li key={index} className="w-full my-1">
                      <Link href={`/buddy/math/${item._id}`} className="">
                        <div
                          className={cn(
